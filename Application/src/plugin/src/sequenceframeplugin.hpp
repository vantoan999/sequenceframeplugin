...
*
* @brief Sequence Frame header file
*
****************************************************************
***********************************
*/
...
private:
    enum DecompressionThreadStatus {
        DecompressionThreadStatus_Idle = 0,
        DecompressionThreadStatus_Working = 1,
        DecompressionThreadStatus_Destroy = 2
    };
...
private:
     ...
     */
    void onTimerShowTexture(const TimerMessageArguments&);

    /**
     * @brief decompress texture on the other thread
     */
    static kzsError decompressTexture(void* userData);
...
private:
    ...
    KzsThread* m_decompressionThread;
    KzsThreadLock* m_decompressionThreadLock;
    ...
    TimerSubscriptionToken m_playTextureTimerToken;
